 ...
 */
fun myGroup(): String {
    val groupMembers = listOf("Wawan", "Dito", "Birrul", "Rama", "Akmal", "Izul")
...
fun main() {
     ...
     *
     */
    groupDetail(1, listOf("Wawan", "Dito", "Birrul", "Rama", "Akmal", "Izul"), "Morning")
